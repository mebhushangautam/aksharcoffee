        ...
        <div class="relative flex flex-col flex-1 min-h-0 pt-0 ltr:border-r rtl:border-l border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div class="flex flex-col flex-1 min-h-0 pt-2 pb-4 mb-16">
                ...
                <div class="shrink-0 px-3 pb-3 border-b border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-700">
                    ...
                    @else
                        <div class="inline-flex w-full min-w-0 items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-2.5 py-2 text-sm font-semibold text-gray-700 dark:border-gray-600 dark:bg-gray-700/50 dark:text-gray-200">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt shrink-0 text-skin-base dark:text-gray-300" viewBox="0 0 16 16" aria-hidden="true">
