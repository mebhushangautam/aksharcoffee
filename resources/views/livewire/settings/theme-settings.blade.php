<div
    ...
    @else
        ...
        <form wire:submit.prevent="submitForm" x-data="{ photoName: null, photoPreview: null, darkPhotoPreview: null }">
            <div class="space-y-6">
                {{-- Logo Upload Section --}}
                <div
                ...
                <div
                    class="p-6 bg-gray-900 rounded-lg shadow-sm border border-gray-700">
                    <div class="flex items-center justify-between mb-4">
                        <div>
                        ...
                        <div class="flex-shrink-0">
                            <div class="relative h-24 w-24">
                                <div x-show="!darkPhotoPreview"
                                    ...
                                    <img src="{{ restaurant()->dark_logo_url }}" alt="{{ restaurant()->name }}"
                                        class="h-24 w-24 object-contain">
                                </div>
                ...
                <div class="flex items-center justify-end space-x-3">
                    <x-button :disabled="$errors->any()" wire:loading.attr="disabled" wire:target="photo, darkPhoto"
                        class="min-w-[100px]">
                        @lang('app.save')
                    </x-button>
                </div>
